      ...
      return knex('events').insert([
        {
          ...
          description: "Une opportunité de venir travailler avec \nles gens de l'Accueil Bonneau",
        ...
        },
        {
          ...
          description: "Joignez-vous à nous pour cette expérience \ninoubliable auprès de la clientèle de \nl'Auberge Madeleine.",
